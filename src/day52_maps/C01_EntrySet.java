...
import day49_collections.MapOlustur;
...
public class C01_EntrySet {
    public static void main(String[] args) {
        ...
        //entrySet'leri tek tek yazdirmak veya tek tek manipule etmek mumkun mu
        //yazdirmak bizim temel hedefimiz degildir ancak yine de manipule etme yontemi vardir
        /*
        myMap.. entrySet(); methodu bize entrylerden olusan bir set dondurur
