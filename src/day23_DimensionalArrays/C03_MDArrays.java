...
public class C03_MDArrays {
    public static void main(String[] args) {
        ...
        //bir okulda 3 tane 24 kisilik, 2 tane de 22 kisilik sinif vardir=>bunu yapamayiz
        //yapmak icin iki tane Array olusturulmali
        int sinif24[][]=new int[3][24];
        int sinif22[][]=new int[2][22];
        //olustururken elementleri atama yaparsak farkli inner array ler tanimlayabiliriz
